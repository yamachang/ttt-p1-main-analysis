#--------------------------------------------------------------------------------#
#Computing the relevant person-specific parameters from VAR and ML-VAR models-----
#Authors: Josip Razum
#--------------------------------------------------------------------------------#
setwd(wd_dir)

#--------------------------------------------------------------------------#
#Computing the person-specific parameters from the 8-node VAR network------#
#--------------------------------------------------------------------------#
#
#---------------------------------------------------------------------#
#Extracting person-specific parameters from the 8-node VAR network----
#---------------------------------------------------------------------#
...
results <- lapply(varfit, function(x) {
  out <- cbind(parameters, 
               x$parameters$stdyx.standardized[c(1:64),
                                               c(3, 6, 7)])
...
#removing the parameters involving time for each participant (every ninth row in the dataframe)


#create a column in the dataframe that signifies to which participant do the given set of coefficients belong. 
# Calculate the number of participants
num_participants <- ceiling(nrow(results) / 64)

# Create the participant labels
participant_labels <- rep(paste0("Participant ", 1:num_participants), each = 64, length.out = nrow(results))
...
#adjacency matrixu treba obrnuti stupce i redove
...
# Naming the list elements by Participant IDs for easier reference
...
expected_influence_wide <- expected_influence_wide [, c("Participant", "bad_step1", "control_step1", "energy_step1", "focus_step1", "fun_step1", "interest_step1", "movement_step1", "sad_step1","bad_step2", "control_step2", "energy_step2", "focus_step2", "fun_step2", "interest_step2", "movement_step2", "sad_step2")]
...
#merge the data frame with expected influence & other parameters with data frames with average control centrality and modal control centrality in a single data frame
all_person_spec_parameters <- all_person_spec_parameters %>%
...
expected_influence_control_wide <- expected_influence_control_wide [, c("Participant", "bad_step1", "control_step1", "energy_step1", "focus_step1", "interest_step1", "movement_step1", "sad_step1","bad_step2", "control_step2", "energy_step2", "focus_step2", "interest_step2", "movement_step2", "sad_step2")]
...
expected_influence_fun_wide <- expected_influence_fun_wide [, c("Participant", "bad_step1", "energy_step1", "focus_step1", "fun_step1", "interest_step1", "movement_step1", "sad_step1","bad_step2", "energy_step2", "focus_step2", "fun_step2", "interest_step2", "movement_step2", "sad_step2")]
...
expected_influence_wide_mlvar <- expected_influence_wide_mlvar [, c("Participant", "bad_step1", "control_step1", "energy_step1", "focus_step1", "fun_step1", "interest_step1", "movement_step1", "sad_step1","bad_step2", "control_step2", "energy_step2", "focus_step2", "fun_step2", "interest_step2", "movement_step2", "sad_step2")]
...
expected_influence_mlvar_control_wide <- expected_influence_mlvar_control_wide [, c("Participant", "bad_step1", "control_step1", "energy_step1", "focus_step1", "interest_step1", "movement_step1", "sad_step1","bad_step2", "control_step2", "energy_step2", "focus_step2", "interest_step2", "movement_step2", "sad_step2")]
...
expected_influence_mlvar_fun_wide <- expected_influence_mlvar_fun_wide [, c("Participant", "bad_step1", "energy_step1", "focus_step1", "fun_step1", "interest_step1", "movement_step1", "sad_step1","bad_step2", "energy_step2", "focus_step2", "fun_step2", "interest_step2", "movement_step2", "sad_step2")]
